...
class WordCloud(object):
    ...
    def __init__(self, font_path=None, width=400, height=200, margin=2,
                 ...
                 color_func=None, max_words=200, min_words=10, min_font_size=8,
                 stopwords=None, random_state=None, background_color='black',
                 max_font_size=None, font_step=1, mode="RGB",
                 relative_scaling='auto', regexp=None, collocations=True,
                 colormap=None, normalize_plurals=True, contour_width=0,
                 contour_color='black', repeat=False,
                 include_numbers=False, min_word_length=0, collocation_threshold=30,en=False):
    ...
    def generate_from_frequencies_small(self, frequencies, max_font_size=None, min_font_size=None):  # noqa: C901
        """Create a word_cloud from words and frequencies.
        ...
        if max_font_size is None:
            ...
            if len(frequencies) == 1:
                ...
                self.generate_from_frequencies_small(dict(frequencies[:2]),
        ...
        for word, freq in frequencies:
            ...
            lines = max(1, word.count('\n'))
            if word[-1]!='\n' and lines!=1:
                lines += 1
            coeff = 1.5*lines if lines>1 else 1
            while True:
                # find possible places using integral image:
                #box_size = (font_size * len(word.split('\n')[0]), (lines+1) * font_size+int(0.15*font_size))
            ...
            # else:
            draw.rectangle((y, x, y+box_size[0], x+box_size[1]), fill='white')
    ...
    def to_image(self):
        ...
        for (word, count), font_size, position, box, orientation, color in self.layout_:
            ...
            draw.multiline_text(pos, word, fill=color, font=transposed_font)
    ...
    def to_svg(self, embed_font=False, optimize_embedded_font=True, embed_image=False):
        ...
        for (word, count), font_size, (y, x), box, orientation, color in self.layout_:
            x *= self.scale
            y *= self.scale
